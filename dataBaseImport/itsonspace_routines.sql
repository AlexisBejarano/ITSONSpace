...
--
-- Dumping routines for database 'itsonspace'
--
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtener_usuario`(
    IN p_nombre VARCHAR(255)
)
BEGIN
    SELECT nombre, AES_DECRYPT(clave, 'Clave128Bits1234') AS clave, tipoDeCuenta
    FROM itsonspace.login
